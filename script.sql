...
CREATE TABLE IF NOT EXISTS `BDARCO`.`DOCUMENTO` (
  ...
  `ETAPA_ARCO_ID` INT(11) NOT NULL,
  PRIMARY KEY (`ID`, `ETAPA_ID`, `ETAPA_ARCO_ID`),
  INDEX `fk_DOCUMENTO_ETAPA1_idx` (`ETAPA_ID` ASC, `ETAPA_ARCO_ID` ASC),
  CONSTRAINT `fk_DOCUMENTO_ETAPA1`
    FOREIGN KEY (`ETAPA_ID` , `ETAPA_ARCO_ID`)
