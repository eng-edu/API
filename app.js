...
const arcoRoute2 = require('./routes/routerArco2')
const arcoRoute3 = require('./routes/routerArco3')
const arcoRoute4 = require('./routes/routerArco4')
...
app.use('/arco2', arcoRoute2)
app.use('/arco3', arcoRoute3)
app.use('/arco4', arcoRoute4)
